        ...
        <div class="row">
            ...
            <div class="col-md-4"><!--footer contact widget-->
                ...
                <ul class="contact-widget">
                    <li class="fphone"><?= $ayarcek['ayar_tel'] ?> <br> <?= $ayarcek['ayar_fax'] ?></li>
                    <li class="fmobile"><?= $ayarcek['ayar_gsm'] ?><br><?= $ayarcek['ayar_gsm'] ?></li>
                    <li class="fmail lastone"><?= $ayarcek['ayar_mail'] ?></li>
                </ul>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3"><!--footer Share-->
                ...
                <div class="">
                    <a href="http://<?= $ayarcek['ayar_twitter'] ?>"><i class="fa-brands fa-twitter fa-2x"></i></a>
                    <a href="http://<?= $ayarcek['ayar_facebook'] ?>"><i class="fa-brands fa-facebook  fa-2x"></i></a>
                    <a href="http://<?= $ayarcek['ayar_google'] ?>"><i class="fa-brands fa-google fa-2x"></i></a>
                    <a href="http://<?= $ayarcek['ayar_youtube'] ?>"><i class="fa-brands fa-youtube fa-2x"></i></a>
                </div>
                <div class="clearfix"></div>
            </div><!--footer Share-->
        </div>
